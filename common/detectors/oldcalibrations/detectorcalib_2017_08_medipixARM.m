...
%DetCalib.docu
%DetCalib.SIZE = [516 516];  % [Y=rows X=columns] = size(image)  
...
'2017-08_Medipix_on_detector arm');
...
DetCalib.colCEN	= 189+1;   %matlab indexing
...
DetCalib.rowCEN	= 344+1;   %matlab indexing
...
%#CR ROI  1: MinX= 185  SizeX=   7 MinY= 340  SizeY=   7 MinZ=   0  SizeZ=   1
end
