...
%
%  zaxis, sevchex: if sigma = |sigma| then, tau is -PHImax-90
%		(tau definition OK for zaxis, and sevchex) 
%  caxis, sevchub: if sigma = |sigma| then, tau is +PHImax-90
%		
%
...
sigmatau.docu		= strvcat(date,...
	...
	['tau calculated from -90 - PHI_max, sigma is tilt ']); 
