...
if all([FLAGS(2)==1 Ncolumns==2]);
	...
	BadPixDocument	= char(['Replace badX badY with goodX goodY using info from '],int2str(BADPIXTXT));
	DOCU			= char(['Replace badX badY with goodX goodY using info from '  pfilename(badpixtxt)]);
...
disp('NaN')
	...
	BadPixDocument 	= char(['Replace badX badY with NaN using info from '],int2str(BADPIXTXT));
	DOCU			= char(['Replace badX badY with NaN using info from ' pfilename(badpixtxt)]);
